...
| Aquatic Reflectance                               | `optical`       | `AR`                     | `1.0` / `2.0`                    | Proposal    |
...
| Combined SAR: Normalised Radar Backscatter (NRB)  | `radar`         | `NRB`                    | `1.0` / `1.1` / `1.2`            | WIP         |
| Combined SAR: Polarimetric Radar (POL)            | `radar`         | `POL`                    | `1.0` / `1.1` / `1.2`            | WIP         |
| Combined SAR: Ocean Radar Backscatter (ORB)       | `radar`         | `ORB`                    | `1.0` / `1.1` / `1.2`            | WIP         |
| Combined SAR: Geocoded Single-Look Complex (GSLC) | `radar`         | `GSLC`                   | `1.0` / `1.1` / `1.2`            | WIP         |
| Combined SAR: Interferometric Radar (INSAR)       | `radar`         | `INSAR`                  | `1.2`                            | WIP         |
